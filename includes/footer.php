...
<footer class="landing-footer bg-body footer-text">
  <div class="footer-top position-relative overflow-hidden z-1">
    <img src="vendor/assets/img/front-pages/backgrounds/footer-bg.png" alt="footer bg"
      ...
      <div class="row gx-0 gy-6 g-lg-10">
        ...
        <div class="col-lg-3 col-md-4">
          ...
          <a href="javascript:void(0);" class="d-block mb-4"><img
              src="vendor/assets/img/front-pages/landing-page/apple-icon.png" alt="apple icon" /></a>
          <a href="javascript:void(0);" class="d-block"><img
              src="vendor/assets/img/front-pages/landing-page/google-play-icon.png" alt="google play icon" /></a>
        </div>
      </div>
    </div>
  </div>
...
<script src="vendor/assets/vendor/libs/@algolia/autocomplete-js.js"></script>

<script src="vendor/assets/vendor/libs/pickr/pickr.js"></script>

<!-- endbuild -->

<!-- Vendors JS -->
<script src="vendor/assets/vendor/libs/nouislider/nouislider.js"></script>
<script src="vendor/assets/vendor/libs/swiper/swiper.js"></script>

<!-- Main JS -->

<script src="vendor/assets/js/front-main.js"></script>

<!-- Page JS -->
<script src="vendor/assets/js/front-page-landing.js"></script>
</body>
